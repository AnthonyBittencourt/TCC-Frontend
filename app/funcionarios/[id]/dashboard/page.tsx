...
const criarAbas = (
...

  {
    ...
    rotaDetalhes: (id) =>
      `/funcionarios/detalhes/listarClientes/${id}`,
...

  {
    ...
    rotaDetalhes: (id) =>
      `/funcionarios/detalhes/listarFuncionarios/${id}`,
...

  {
    ...
    rotaDetalhes: (id) =>
      `/funcionarios/detalhes/listarContas/${id}`,
...

  {
    ...
    rotaDetalhes: (id) =>
      `/funcionarios/detalhes/listarAgencia/${id}`,
...

  {
    ...
    rotaDetalhes: (id) =>
      `/funcionarios/detalhes/listarTransacoes/${id}`,
